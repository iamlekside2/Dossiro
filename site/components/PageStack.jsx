...
export default function PageStack({ className }) {
  return (
    ...
    >
      ...
      <g opacity="0.95">
        <path d="M250 96 L516 150 L470 402 L214 340 Z" fill="var(--g-navy)" />
        <path d="M212 118 L474 176 L432 420 L182 356 Z" fill="var(--g-blue)" />
        <path d="M176 142 L430 202 L392 436 L152 372 Z" fill="var(--g-sky)" />
        <path d="M142 168 L384 228 L350 450 L126 388 Z" fill="var(--g-teal)" />
      </g>

      {/* The live document, front and upright */}
      <g>
        <rect x="44" y="70" width="256" height="340" fill="#ffffff" stroke="var(--line-strong)" strokeWidth="1.5" />

        {/* Title block */}
        <rect x="72" y="104" width="120" height="14" fill="var(--blue-ink)" />
        <rect x="72" y="130" width="180" height="9" fill="var(--line)" />

        {/* Two typed index-field chips */}
        <rect x="72" y="162" width="86" height="26" fill="var(--blue-tint)" stroke="var(--blue-line)" strokeWidth="1" />
        <rect x="84" y="172" width="52" height="6" fill="var(--blue)" />
        <rect x="170" y="162" width="86" height="26" fill="var(--blue-tint)" stroke="var(--blue-line)" strokeWidth="1" />
        <rect x="182" y="172" width="40" height="6" fill="var(--blue)" />
        ...
        <rect x="72" y="352" width="96" height="1.5" fill="var(--ink-2)" />
        <path
